    ...
    <div className={styles.container}>
      ...
      <section className={styles.hero}>
        <div className={styles.heroContent}>
          ...
          <p className={styles.heroSubtitle}>Stop swiping. Start connecting.</p>

          <button className={styles.heroButton}>Join the Waitlist</button>
        </div>
      </section>
        ...
        <div className={styles.sectionContent}>
          ...
          <div className={styles.featureGrid}>
            <div className={styles.featureCard}>
              ...
              <p>
                No boring forms. Just talk to our AI about who you are and what
                you're looking for. It understands you.
              </p>
            </div>
            <div className={styles.featureCard}>
              <div className={styles.featureIcon}>
          ...
          <div className={styles.stepsContainer}>
            ...
            <div className={styles.step}>
              ...
              <div className={styles.stepContent}>
                ...
                <p>
                  Our AI understands your intentions, values, and compatibility
                  factors—not just your photos.
                </p>
              </div>
            </div>
            <div className={styles.step}>
